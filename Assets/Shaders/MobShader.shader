	...
	SubShader
	{
		...
		Pass
		{
			...
			Varyings CombinedShapeLightVertex(Attributes v)
			{
				...
				float4 pos = TransformWorldToHClip(_FeetPos);
				float4 clipVertex = pos / pos.w;
				o.lightingUV = ComputeScreenPos(clipVertex).xy;
				clipVertex = o.positionCS / o.positionCS.w;
				o.lightingUV = lerp(o.lightingUV, ComputeScreenPos(clipVertex).xy, 0.1);
				o.color = v.color;
				return o;
			}
