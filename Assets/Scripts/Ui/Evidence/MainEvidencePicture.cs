...
public class MainEvidencePicture : MonoBehaviour
{
    ...
    //Quick methods to change the currently hovered over evidence
    ...
    //When you lock a picture send it to the GC that will send a Send Evidence message to the network handler.
    ...
    //When you lock a sensorlist send it to the GC that will send a Send Evidence message to the network handler.
    ...
    //When you lock a pulse checker evidence send it to the GC that will send a Send Evidence message to the network handler.
    ...
    //When you lock a Smoke grenade evidence send it to the GC that will send a Send Evidence message to the network handler.
