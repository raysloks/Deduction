...
public class SmokeGrenadeEvidencePrefab : MonoBehaviour, IPointerEnterHandler, IPointerClickHandler, IPointerExitHandler
{
    //Script for smoke grenade prefab that gets spawned by evidence handler

    //***** These get filled in during creation process in Evidence handler
    [HideInInspector] public SGEvidence sge;
    //*****
